...
public class AllocationHelper {
    ...
    // HARD CONSTRAINT: Teacher cannot have conflicting internship types (e.g. SFP + ZSP might be invalid in some rules)
    ...
    // SOFT CONSTRAINT: Does the teacher know this subject? (Used in Demand Phase, used for mapping in Surplus)
    ...
    // SOFT CONSTRAINT: Did the teacher say they are available? (Ignored in Surplus Phase)
    ...
    // HARD CONSTRAINT: Explicit exclusions
