...
@NoArgsConstructor
/**
 * Entity representing demand for internship positions per school type, academic year, internship type, and subject.
 * Tracks required positions for allocation planning.
 */
