...
public class CreditHourTrackingMapper implements BaseMapper<CreditHourTracking, Object, de.unipassau.allocationsystem.dto.credittracking.CreditHourTrackingUpdateDto, CreditHourTrackingResponseDto> {
    ...
    @Override
    public CreditHourTracking toEntityCreate(Object createDto) { return null; }

    @Override
    public CreditHourTracking toEntityUpdate(de.unipassau.allocationsystem.dto.credittracking.CreditHourTrackingUpdateDto updateDto) { return null; }
    ...
    public CreditHourTrackingResponseDto toResponseDto(CreditHourTracking entity) {
        ...
        if (entity.getAcademicYear() != null) dto.setYearId(entity.getAcademicYear().getId());
    ...
    public void updateEntityFromDto(de.unipassau.allocationsystem.dto.credittracking.CreditHourTrackingUpdateDto updateDto, CreditHourTracking entity) {
        ...
        if (updateDto.getNotes() != null) entity.setNotes(updateDto.getNotes());
        if (updateDto.getCreditHoursAllocated() != null) entity.setCreditHoursAllocated(updateDto.getCreditHoursAllocated());
        if (updateDto.getCreditBalance() != null) entity.setCreditBalance(updateDto.getCreditBalance());
    }
}
