 ...
 */
export interface DataTableActionsColumnProps<TData> {
 ...
 */
export function ActionButton({ onClick, icon, label, className = "", variant = "ghost" }: ActionButtonProps) {
    return (
        <Tooltip>
 ...
 */
export function ActionsCell<TData>({ rowData, props }: ActionsCellProps<TData>) {
